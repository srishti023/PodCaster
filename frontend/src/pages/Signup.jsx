      ...
      <div className="w-4/6 md:w-3/6 lg:w-2/6 flex flex-col items-center justify-center">
        ...
        <div className="mt-6 w-full">
          <div className='w-full flex flex-col'>
            ...
            <input type="text" className='mt-2 px-2 py-2 rounded-full outline-none border border-black' required placeholder='Enter Username ...' name="username"/>
          </div>
          ...
          <div className='w-full flex flex-col mt-6'>
            <button className='bg-green-900 font-semibold text-xl text-white rounded-full py-2'>Signup</button>
          </div>
          <div className='w-full flex flex-col mt-6'>
